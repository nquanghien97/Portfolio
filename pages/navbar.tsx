...
export default function NavBar (props: NavBarProps) {
    ...
    return (
        <>
            <div className="fixed top-0 right-0 left-0 flex justify-center dark:bg-gray-800 border-gray-200 z-10">
    ...
    function SideMenu(){
        return(
            <div className="max-w-screen-lg fixed h-screen w-full right-0 bg-zinc-200/[0.6] -z-50 pt-4 px-4 sm:w-1/4 lg:hidden top-12">
                <ul className="menu-list flex flex-col text-xs font-bold text-xl">
                    <li className="menu-list-item py-3"><a href="#">Home</a></li>
                    <li className="menu-list-item py-3"><a href="#">About</a></li>
                    <li className="menu-list-item py-3"><a href="#">Services</a></li>
                    <li className="menu-list-item py-3"><a href="#">Contact</a></li>
                </ul>
            </div>
        )
    }
