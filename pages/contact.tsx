...
export default function Contact () {
    ...
    const sendEmail = (e: FormEvent<HTMLFormElement>) => {
        ...
        emailjs.sendForm('nquanghien97', 'template_sj1vbhn', form, 'fyQXTkIk7xG-acE0o')
          .then((result) => {
              console.log(result);
      ...
      <Fade left>
        <div id="contact" className="contact flex justify-center mx-auto md:py-28 pb-8">
          ...
          <div className="relative md:flex-[0_0_60%]">
            ...
            {error && (<div className="absolute top-5 right-0 bg-red-200 w-52 h-9 flex items-center justify-center rounded">Gửi thành công<CheckCircleOutlineIcon style={{color: 'green', margin:'0 4px'}}/></div>)}
            </div>
          </div>
        </div>
      </Fade>
